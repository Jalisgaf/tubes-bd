    ...
    <div class="container-fluid">
        ...
        <div class="col-2">
            <div class="list-group">
                ...
                <a href="viewdata.php" class="list-group-item list-group-item-action active">Data Barang</a>
                ...
                <?php 
                    ...
                    if ($db -> connect_errno == 0) {
                        ...
                        $sql = "SELECT * FROM barang
                                WHERE IdBarang LIKE '%$dicari%' OR
                                NamaBarang LIKE '%$dicari%'
                            ";
                        ...
                        if ($res) {
                            ...
                            <table class="table table-hover table-bordered">
                                <thead class="thead-light text-center">
                                    <tr>
                                        <th>No</th><th>Id Barang</th><th>Nama Barang</th><th>Option</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    foreach($data as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="edit.php?IdBarang=<?= $row["IdBarang"]?>" class="btn btn-primary btn-flat btn-xs">Edit</a>  
                                                <a href="hapus.php?IdBarang=<?= $row["IdBarang"]?>" class="btn btn-danger btn-flat btn-xs">Hapus</a></td>
                                        </tr>
                                        <?php
                                        $no++;
                                    }
